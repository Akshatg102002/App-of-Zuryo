...
const AppLayout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    return (
        <div className="h-[100dvh] bg-gray-50 flex flex-col font-sans w-full overflow-hidden select-none text-secondary touch-manipulation">
             ...
             {/* Adjusted top padding for desktop. Added pb-24 for mobile to account for compact fixed nav */}
             <main className="flex-1 w-full overflow-y-auto md:pt-28 pb-24 md:pb-0 scroll-smooth relative overscroll-contain">
                {children}
             </main>
